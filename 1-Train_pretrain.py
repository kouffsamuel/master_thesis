...
from model.RadViT_pretrain import RadViTPretrain
...
def main(config=None, resume=None, exp_name=None): 
    ...
    net = nn.DataParallel(RadViTPretrain(parameters['D'], parameters['p'], parameters['H'], parameters['W'], parameters['neuron'], parameters['mha'], parameters['layer'], parameters['dropout'], parameters['n_encoders'], data_mode=config['data_mode']), device_ids=[0,1,2,3])
    net.to(device)
